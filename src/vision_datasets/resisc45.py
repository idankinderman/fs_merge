...
class VisionDataset(Dataset[Dict[str, Any]], abc.ABC):
    """Abstract base class for vision_datasets lacking geospatial information.
    This base class is designed for vision_datasets with pre-defined image chips.
    """
...
class VisionClassificationDataset(VisionDataset, ImageFolder):
    """Abstract base class for classification vision_datasets lacking geospatial information.
    This base class is designed for vision_datasets with pre-defined image chips which
...
class RESISC45:
    def __init__(self,
        ...
        self.val_dataset = RESISC45Dataset(root=location, split='val', transforms=preprocess)
